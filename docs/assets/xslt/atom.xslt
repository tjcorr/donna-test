...
<xsl:template match="/atom:feed">
	...
	<link rel="canonical" href="http://localhost:4000/donna-test/assets/xslt/atom.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="Atom Feed (Styled)">
	<meta property="og:description" content="">
	<meta property="og:url" content="http://localhost:4000/donna-test/assets/xslt/atom.xslt">
